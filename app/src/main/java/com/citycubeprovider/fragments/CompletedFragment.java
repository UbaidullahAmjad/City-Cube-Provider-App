...
import com.citycubeprovider.adapters.AdapterCompleteBooking;
import com.citycubeprovider.databinding.FragmentActiveBinding;
import com.citycubeprovider.databinding.FragmentCompletedBinding;
...
public class CompletedFragment extends Fragment {
    ...
    AdapterCompleteBooking adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new AdapterCompleteBooking(getActivity(),arrayList);
    ...
    private void getActiveBooking() {
        ...
        Log.e(TAG, "get Complete Booking Service Request " + map);
        ...
        loginCall.enqueue(new Callback<BookingModel>() {
            ...
            public void onResponse(Call<BookingModel> call, Response<BookingModel> response) {
                ...
                try {
                    ...
                    Log.e(TAG, "get Complete Booking Service Response :" + responseString);
