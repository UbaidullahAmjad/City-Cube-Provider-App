...
import java.util.ArrayList;
  ...
  public class AdapterType2 extends BaseAdapter {
        Context context;
        ArrayList<CarListModel2.Result> categoryList;
        LayoutInflater inflater;


        public AdapterType2(Context context, ArrayList<CarListModel2.Result> categoryList) {
